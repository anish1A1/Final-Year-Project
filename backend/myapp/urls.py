...
from .views import get_stream_token, create_product_chat, get_stream_token, create_trade_chat, create_equipment_chat
...
urlpatterns = [
    ...
    path("chat/create-equipment-chat/<int:equipment_id>/", create_equipment_chat, name="create_equipment_chat"),
