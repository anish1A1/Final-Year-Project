      ...
      <div className="container mx-auto px-6 md:px-8 ">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>Email: <span className="hover:text-white transition-colors duration-200">alloozpat64@gmail.com</span></li>
              ...
              <li>
                ...
                <span className="hover:text-white  transition-colors duration-200">
                  Dharan, Sunsari, Province-1, Nepal
                </span>
              </li>
            </ul>
            {/* Social Media Links */}
  ...
  <Link
    href={
      platform === "Twitter"
        ? "#"
        : platform === "LinkedIn"
        ? "https://www.linkedin.com/in/anish-jaiswal-se/"
        : platform === "Facebook"
        ? "https://www.facebook.com/anish.jaiswal.520900/"
        : platform === "Instagram"
        ? "https://www.instagram.com/_anish_jaiswal/?hl=en"
        : "#"
    }
    key={index}
    className="hover:text-white transition-colors text-slate-400 duration-200 cursor-pointer"
  >
